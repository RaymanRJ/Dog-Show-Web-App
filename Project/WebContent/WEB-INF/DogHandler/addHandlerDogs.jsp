	...
	<body>
			...
			<a class="navbar-brand" href="splash">
		  	...
		  	<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav mr-auto">
					...
					<li class="nav-item">
						<a class="nav-link py-0" href="handlerMain">Handler Login</a>
					</li>
				</ul>
			</div>
		</nav>
		...
		<div class="container">
			...
			<table class="table table-striped table-hover">
				...
				<form method="POST" action="updateHandlerList" id="view-dog-form">
				
					<f:BuildDogList dogBeans="${dogs }" currentDogs="${currentDogs }"/>
					
					<button type="submit" class="btn btn-primary">Add Dogs</button>
				</form>
